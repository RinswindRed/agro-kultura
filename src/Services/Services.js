...
class Services extends React.Component {
  ...
  render() {
    const { activeIndex} = this.state;
    return (
      <Segment style={{backgroundColor:'darkseagreen'}}>
        <Accordion fluid styled>
          ...
          >
            <Icon name="dropdown" />
            Izrada nacrta i nabavka elemenata za postavljanje protivgradnih mreza
          </Accordion.Title>
          ...
          >
            <Icon name="dropdown" />
            Pomoc prilikom prikupljanja dokumentacije za podsticajna sredstva raspisana od strane Ministarstva poljoprivrede
          </Accordion.Title>
          ...
          >
            <Icon name="dropdown" />
            Nabavka sertifikovanog sadnog materijala svih vrsta voca i vinove loze
          </Accordion.Title>
